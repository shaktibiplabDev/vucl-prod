...
--
-- Table structure for table `acknowledgement_slips`
--

CREATE TABLE `acknowledgement_slips` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `acknowledgement_slips`
--
ALTER TABLE `acknowledgement_slips`
  ADD PRIMARY KEY (`id`),
  ADD KEY `service_app_id_idx` (`service_key`,`application_id`);
...
--
-- AUTO_INCREMENT for table `acknowledgement_slips`
--
ALTER TABLE `acknowledgement_slips`
